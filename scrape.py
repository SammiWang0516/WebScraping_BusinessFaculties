"""
Scrapes faculty data from university websites into per-university CSVs.

Usage (standalone):
  python scrape.py                 # scrape all universities in config
  python scrape.py --index 01      # scrape only university index 01
  python scrape.py --index 01 02   # scrape specific universities
"""
